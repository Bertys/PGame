...
function iniciaHorarios(){
    var varaux='S1:'+matrand()+'min, '+(matrand()+5)+'min, '+(matrand()+5)+'min';
        varaux+='<br>';
        varaux+='S2 '+matrand()+'min, '+(matrand()+10)+'min, '+(matrand()+20)+'min';
        varaux+='<br>';
        varaux+='S5 '+matrand()+'min, '+(matrand()+10)+'min, '+(matrand()+20)+'min';
        varaux+='<br>';
        varaux+='S55 '+matrand()+'min, '+(matrand()+10)+'min, '+(matrand()+20)+'min';
    document.getElementById("horarios1").innerHTML=varaux;
}
function hideAll(){
